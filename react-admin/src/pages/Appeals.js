...
function Appeals({ onViewUserDetail }) {
    ...
    const QUICK_REPLIES = [
        ...
        { icon: "🔰", label: "تنبيه أول مرة (ترويج خارجي)", text: "تم تقييدك بسبب محاولة مشاركة حسابات خارجية. كأول مرة، سنرفع التقييد كاستثناء. سياسة المنصة تمنع مشاركة أو طلب الحسابات والأرقام خارج التطبيق لحمايتك من الاحتيال. أي مخالفة قادمة قد تؤدي إلى حظر دائم." },
