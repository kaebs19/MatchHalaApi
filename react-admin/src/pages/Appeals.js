...
function Appeals({ onViewUserDetail }) {
    ...
    const QUICK_REPLIES = [
        ...
        // ─── ترويج خارجي — تدرّج حسب التكرار ───
        { icon: "🔰", label: "تنبيه أول مرة (ترويج خارجي)", text: "تم تقييد حسابك بسبب محاولة مشاركة حسابات خارجية (سناب، انستا، واتساب، تيليجرام، زنجي، أو أرقام تواصل). نظراً لأنها أول مخالفة من هذا النوع، سيتم رفع التقييد كاستثناء. نُذكّرك بأن سياسة المنصة تمنع منعاً باتاً:\n• مشاركة الحسابات على المنصات الخارجية\n• طلب أو إعطاء أرقام تواصل خارج التطبيق\n• توجيه المستخدمين لمنصات أخرى\nالهدف حمايتك وحماية باقي المستخدمين من الاحتيال والاستغلال. أي مخالفة قادمة قد تؤدي إلى تقييد أطول أو حظر دائم." },
        { icon: "🛑", label: "منع مشاركة حسابات (تحذير)", text: "تم تقييد حسابك بسبب محاولة مشاركة أو طلب حسابات خارجية. هذا يخالف سياسة المنصة بوضوح ويُعرّض المستخدمين للاحتيال خارج بيئتنا الآمنة. يُرجى الالتزام بإجراء جميع المحادثات داخل التطبيق فقط." },
        { icon: "⚠️", label: "تحذير أخير قبل الحظر", text: "هذه ليست المرة الأولى التي يُقيَّد فيها حسابك بسبب مشاركة حسابات خارجية. أي مخالفة قادمة ستؤدي إلى حظر دائم لحسابك دون إنذار. يُرجى مراجعة شروط الاستخدام والالتزام بها." },
        { icon: "🔒", label: "رفض (مُكرِّر للترويج)", text: "بعد مراجعة سجلك، تبيّن أن هذه ليست المرة الأولى التي تتم فيها محاولة مشاركة حسابات خارجية. تم رفض استئنافك وإبقاء التقييد سارياً وفقاً لسياسة المنصة الصارمة في هذا الشأن." },

        // ─── سياسة المحتوى ───
        { icon: "🛡️", label: "سياسة المحتوى", text: "المحتوى الذي تم نشره يخالف سياسة المحتوى في التطبيق. يرجى مراجعة الشروط للتأكد من الالتزام بها." },
        { icon: "❗", label: "توضيح المخالفة", text: "التقييد تم بسبب مخالفة سياسة المحادثات. لا يمكن رفعه خلال فترة التقييد." },

        // ─── قرارات نهائية ───
        { icon: "✅", label: "قبول", text: "تم قبول استئنافك. تم فك التقييد عن حسابك، مرحباً بك مجدداً. نأمل الالتزام بسياسة المنصة لتجنب أي إجراءات مستقبلية." },
