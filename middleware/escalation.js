...
const ESCALATION_LEVELS = {
    ...
    1: { type: 'warn',      text: 'تنبيه أول',           pushTitle: '⚠️ تنبيه تلقائي',          pushBody: 'اكتشف نظام الحماية مخالفة لسياسة الاستخدام. هذا تنبيه أول — يُرجى الالتزام بالشروط.' },
    2: { type: 'warn',      text: 'تنبيه أخير',          pushTitle: '🔴 تنبيه أخير',            pushBody: 'تنبيه أخير — رصد نظام الحماية مخالفة متكررة. المخالفة القادمة ستؤدي لتقييد الحساب تلقائياً.' },
    3: { type: 'restrict',  text: 'تقييد جزئي (24h)',    pushTitle: '🔒 تقييد تلقائي',          pushBody: 'تمّ تقييد الحساب تلقائياً بعد رصد مخالفات. لا يمكن بدء محادثات جديدة لمدة 24 ساعة.', level: 'new_only', hours: 24 },
    4: { type: 'restrict',  text: 'تقييد كامل (48h)',    pushTitle: '🔒 تقييد كامل تلقائي',     pushBody: 'تمّ تقييد الحساب تلقائياً بعد رصد مخالفات متكررة. لا يمكن إرسال رسائل لمدة 48 ساعة.',    level: 'all',      hours: 48 },
    5: { type: 'suspend',   text: 'إيقاف (3 أيام)',      pushTitle: '⛔ إيقاف تلقائي للحساب',   pushBody: 'تمّ إيقاف الحساب تلقائياً لمدة 3 أيام بعد رصد مخالفات متكررة لسياسة الاستخدام.',      hours: 72 },
    6: { type: 'suspend',   text: 'إيقاف (7 أيام)',      pushTitle: '⛔ إيقاف تلقائي للحساب',   pushBody: 'تمّ إيقاف الحساب تلقائياً لمدة 7 أيام بعد رصد مخالفات متكررة لسياسة الاستخدام.',      hours: 168 },
    7: { type: 'ban',       text: 'إيقاف نهائي + جهاز',  pushTitle: '🚫 إيقاف نهائي تلقائي',    pushBody: 'تمّ إيقاف الحساب والجهاز تلقائياً بشكل نهائي بعد رصد مخالفات متكررة لسياسة الاستخدام.' },
};
