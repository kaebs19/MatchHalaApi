...
const CACHE_TTL = {
    // ⚠️ كانت دقيقة واحدة: إحصاءات اللوحة تُبنى من عشرات العدّات على
    //    مجموعات بالملايين، وإبطالها كل دقيقة (وعند كل تعديل مستخدم أو
    //    محادثة أو بلاغ) يعني أن المسار البطيء هو الغالب لا الاستثناء.
    //    خمس دقائق كافية لصفحة نظرة عامة.
    DASHBOARD_STATS: 300,
